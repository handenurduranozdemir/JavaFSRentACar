...
export const APIS = [AuthControllerService, BrandsControllerService, CarsControllerService, FuelsControllerService, ModelsControllerService, TransmissionsControllerService];
