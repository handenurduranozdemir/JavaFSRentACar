...
export class ModelsControllerService implements ModelsControllerServiceInterface {
     ...
     */
    public createModel(requestParameters?: CreateModelRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*' | 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<CreatedModelResponse>;
    public createModel(requestParameters?: CreateModelRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*' | 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<CreatedModelResponse>>;
    public createModel(requestParameters?: CreateModelRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*' | 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<CreatedModelResponse>>;
    public createModel(requestParameters?: CreateModelRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*' | 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/api/v1/models/create`;
